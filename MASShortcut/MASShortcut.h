...
*/
@property (unsafe_unretained, nonatomic, readonly) NSString *keyCodeString;
...
*/
@property (unsafe_unretained, nonatomic, readonly) NSString *keyCodeStringForKeyEquivalent;

/**
 A string representing the shortcut modifiers, like the `⌘` in `⌘5`.
*/
@property (unsafe_unretained, nonatomic, readonly) NSString *modifierFlagsString;
